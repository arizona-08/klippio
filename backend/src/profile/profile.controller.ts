import { Body, Controller, Patch, Put, UploadedFile, UseGuards, UseInterceptors } from "@nestjs/common";
...
export  class ProfileController {
  ...
  async editUserPicture(
    ...
    const updatedUser = await this.profileService.editUserPicture(user.id, file, body);
    return updatedUser;
  }
}